...
\section{General theoretical framework of Loyalty Signaling}
    ...
    authoritarian regime: i) officials with a less-trusted background has a greater incentive to signal their loyalty to the authoritarian leader; ii) credible loyalty signaling 
    becomes particularly significant for an official if his/her career prospect and political survival is largely determined by the ruler's favor, which is often the case in an 
    authoritarian regime; iii) one of the most effective way for a less-trusted official to express his/her loyalty is to engage in ``unpopular and costly'' tasks on the ruler's 
