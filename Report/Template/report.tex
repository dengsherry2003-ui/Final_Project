...
\dates{This manuscript was compile on April 30, 2026}
...
\section{Methodology}
    ...
    \subsection{Data Collection}
        ...
        \begin{itemize}
            ...
            \item Central leaders' HK-related speeches: \inlinecode{Data/Data_Raw/Central/Liason_Office/State_Leader}
        \end{itemize}
        
        The primary source of data consists of Chief Executive (CE) speeches and government press releases spanning 
        from 1997 to 2026.\footnote{Press release (Traditional Chinese): \url{https://www.ceo.gov.hk/tc/press.html}; 
        CE speeches: \url{https://www.ceo.gov.hk/tc/speeches.html}; Archive of past CE's speeches and press releases: 
        \url{https://www.ceo.gov.hk/tc/links.html}}
        
        Data regarding central leaders' speeches about Hong Kong was accessed from the Liaison Office of the Central 
        People's Government (LOCPG) website: \url{http://www.locpg.gov.cn/zxzx/zysy.htm}。但资料只包含习近平主席在任和
        候任期间的相关国家领导人涉港言论。
