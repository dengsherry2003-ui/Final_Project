...
\section{Bibliography}
    ...
    \begin{thebibliography}{99}
        \bibitem{PFGPlots} Christian Feuersänger. (2024). PGFPlots: A LaTeX package to create normal/logarithmic plots in two and three dimensions. \url{https://ctan.org/pkg/pgfplots}
    \end{thebibliography}
